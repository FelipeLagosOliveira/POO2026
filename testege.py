...
class TelaJogo(TelaComFundo):
    ...
    def on_draw(self):
        ...
        # 2. Desenha os objetos do jogo sobre o fundo
    ...
    def on_update(self, delta_time):
        ...
        for moeda in arcade.check_for_collision_with_list(self.jogador, self.sprite_moedas):
            ...
            # Se a moeda for especial (vale 10), aumenta a velocidade do jogador
            if moeda.valor == 10:
                self.velocidade += 0.5  # Aumenta em 1 a velocidade base a cada moeda especial
